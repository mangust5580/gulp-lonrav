...
const dict = {
  ru: {
    ...
    cmd_fast: '<code>gulp buildFast</code> — ускоренная production сборка (без тяжёлых оптимизаций)',
  ...
  en: {
    ...
    cmd_fast: '<code>gulp buildFast</code> — faster production build (skips heavy optimizations)',
